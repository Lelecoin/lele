...
public final class Nxt {
    ...
    public static final String APPLICATION = "LELE";
    ...
    public static void shutdown() {
        ...
        Db.shutdown();
        Logger.logShutdownMessage("LELE server " + VERSION + " stopped.");
        Logger.shutdown();
    ...
    private static class Init {
        ...
        static {
            try {
                ...
                Logger.logMessage("LELE server " + VERSION + " started successfully.");
                Logger.logMessage("Copyright © 2013-2016 The Nxt Core Developers.");
                Logger.logMessage("Copyright © 2016-2017 Jelurida IP B.V.");
                Logger.logMessage("Copyright © 2018 E-chain Core Developers.");
