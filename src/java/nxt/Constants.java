...
public final class Constants {
    ...
    public static final String ACCOUNT_PREFIX = "LELE";
    ...
    static {
        try {
            EPOCH_BEGINNING = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss Z")
                    .parse("2018-02-10 12:00:00 +0700").getTime();
        } catch (Exception e) {
    ...
    public static final int CHECKSUM_BLOCK_1 = Constants.isTestnet ? 0 : 0;

    public static final int LAST_CHECKSUM_BLOCK = CHECKSUM_BLOCK_1;
    public static final int LAST_KNOWN_BLOCK = CHECKSUM_BLOCK_1;
    public static final long LAST_KNOWN_BLOCK_ID = Convert.parseUnsignedLong(isTestnet ? "10641888276652163810" : "10879235947882846093");
