        ...
        try {
            ...
            if (chain instanceof ChildChain) {
                ...
                if (referencedTransactionId != null) {
                    return JSONResponses.error("Referenced transactions not allowed for LELE transactions");
                }
                if (encryptedMessage != null) {
                    return JSONResponses.error("Permanent encrypted message attachments not allowed for LELE transactions");
                }
                if (message != null) {
                    return JSONResponses.error("Permanent message attachments not allowed for LELE transactions");
                }
                if (publicKeyAnnouncement != null) {
                    return JSONResponses.error("Public key announcement attachments not allowed for LELE transactions");
                }
                if (encryptToSelfMessage != null) {
                    return JSONResponses.error("Encrypted to self message attachments not allowed for LELE transactions");
                }
                if (phasing != null) {
                    return JSONResponses.error("Phasing attachments not allowed for LELE transactions");
                }
            }
