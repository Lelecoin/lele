...
public class TestCreatePoll extends BlockchainTest {
    ...
    public void createInvalidPoll() {
        APICall apiCall = new CreatePollBuilder().minBalance(-ChildChain.SEMAR.ONE_COIN).build();
    ...
    public static class CreatePollBuilder extends APICall.Builder {
        ...
        public CreatePollBuilder() {
            ...
            feeNQT(10 * ChildChain.SEMAR.ONE_COIN);
            param("name", "Test1");
            ...
            param("minBalance", 10 * ChildChain.SEMAR.ONE_COIN);
