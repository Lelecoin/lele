...
public class PhasingOnlyTest extends BlockchainTest {
    ...
    public void testSetAndGet() throws Exception {
        ...
        setPhasingOnlyControl(VotingModel.ACCOUNT, null, 1L, null, null, new long[] {BOB.getId()},
                10 * ChildChain.SEMAR.ONE_COIN, 5, 1440);
        ...
        assertPhasingOnly(new PhasingParams(new VoteWeighting(VotingModel.ACCOUNT.getCode(), 0L, 0L, (byte)0),
                ...
                buildMaxFeesJSON(ChildChain.SEMAR.getId(), 10 * ChildChain.SEMAR.ONE_COIN), 5, 1440);
    }
    ...
    public void testAccountVoting() throws Exception {
        ...
        Builder builder = new ACTestUtils.Builder("sendMoney", ALICE.getSecretPhrase())
            .recipient(BOB.getId())
            .param("amountNQT", ChildChain.SEMAR.ONE_COIN);
    ...
    public void testExtraRestrictions() throws Exception {
        ...
        setPhasingOnlyControl(VotingModel.ACCOUNT, null, 1L, null, null, new long[] {BOB.getId(), CHUCK.getId()},
                5 * ChildChain.SEMAR.ONE_COIN, 4, 100);

        Builder builder = new ACTestUtils.Builder("sendMoney", ALICE.getSecretPhrase())
                .recipient(BOB.getId())
                .param("amountNQT", ChildChain.SEMAR.ONE_COIN)
                .feeNQT(7 * ChildChain.SEMAR.ONE_COIN);
        // fee too high
        setTransactionPhasingParams(builder, 20, VotingModel.ACCOUNT, null, 1L, null, null, new long[] {BOB.getId(), CHUCK.getId()});
        ACTestUtils.assertTransactionBlocked(builder);

        // fee at the limit
        builder.feeNQT(5 * ChildChain.SEMAR.ONE_COIN);
    ...
    public void testRejectingPendingTransaction() throws Exception {
        ...
        long amount = ChildChain.SEMAR.ONE_COIN;
        Builder builder = new ACTestUtils.Builder("sendMoney", ALICE.getSecretPhrase())
            .recipient(BOB.getId())
    ...
    public void testBalanceVoting() {
        setPhasingOnlyControl(VotingModel.COIN, "2", 100 * ChildChain.SEMAR.ONE_COIN, null, null, null, 0, 0, 0);
        ...
        setTransactionPhasingParams(builder, 20, VotingModel.COIN, "2", 100 * ChildChain.SEMAR.ONE_COIN, null, null, new long[] {DAVE.getId()});
        ACTestUtils.assertTransactionBlocked(builder);

        setTransactionPhasingParams(builder, 20, VotingModel.ACCOUNT, null, 1L, null, null, new long[] {BOB.getId(), CHUCK.getId()});
        ACTestUtils.assertTransactionBlocked(builder);

        setTransactionPhasingParams(builder, 20, VotingModel.COIN, "2", 100 * ChildChain.SEMAR.ONE_COIN + 1, null, null, null);
        ACTestUtils.assertTransactionBlocked(builder);
        ...
        setTransactionPhasingParams(builder, 20, VotingModel.COIN, "2", 100 * ChildChain.SEMAR.ONE_COIN, null, null, null);
        ACTestUtils.assertTransactionSuccess(builder);
    }
