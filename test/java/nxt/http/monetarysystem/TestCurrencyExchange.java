...
public class TestCurrencyExchange extends BlockchainTest {
    ...
    public void buyCurrency() {
        ...
        AccountCurrencyBalance initialSellerBalance = new AccountCurrencyBalance(ALICE.getSecretPhrase(), currencyId, ChildChain.SEMAR);
        AccountCurrencyBalance initialBuyerBalance = new AccountCurrencyBalance(BOB.getSecretPhrase(), currencyId, ChildChain.SEMAR);
        ...
        AccountCurrencyBalance afterOfferSellerBalance = new AccountCurrencyBalance(ALICE.getSecretPhrase(), currencyId, ChildChain.SEMAR);
        Assert.assertEquals(new AccountCurrencyBalance(-1000*95 - ChildChain.SEMAR.ONE_COIN, -ChildChain.SEMAR.ONE_COIN, -500, 0),
        ...
        apiCall = new APICall.Builder("currencyBuy").
                secretPhrase(BOB.getSecretPhrase()).feeNQT(ChildChain.SEMAR.ONE_COIN).
        ...
        AccountCurrencyBalance afterBuySellerBalance = new AccountCurrencyBalance(ALICE.getSecretPhrase(), currencyId, ChildChain.SEMAR);
        Assert.assertEquals(new AccountCurrencyBalance(2000, 200 * 105, 0, -200),
                afterBuySellerBalance.diff(afterOfferSellerBalance));

        AccountCurrencyBalance afterBuyBuyerBalance = new AccountCurrencyBalance(BOB.getSecretPhrase(), currencyId, ChildChain.SEMAR);
        Assert.assertEquals(new AccountCurrencyBalance(-200*105 - ChildChain.SEMAR.ONE_COIN, -200*105 - ChildChain.SEMAR.ONE_COIN, 200, 200),
    ...
    public void sellCurrency() {
        APICall apiCall1 = new TestCurrencyIssuance.Builder().type(CurrencyType.EXCHANGEABLE.getCode()).build();
        String currencyId = TestCurrencyIssuance.issueCurrencyApi(apiCall1);
        AccountCurrencyBalance initialBuyerBalance = new AccountCurrencyBalance(ALICE.getSecretPhrase(), currencyId, ChildChain.SEMAR);
        AccountCurrencyBalance initialSellerBalance = new AccountCurrencyBalance(BOB.getSecretPhrase(), currencyId, ChildChain.SEMAR);
        ...
        // The buy offer reduces the unconfirmed balance but does not change the confirmed balance
        // The sell offer reduces the unconfirmed currency units and confirmed units
        AccountCurrencyBalance afterOfferBuyerBalance = new AccountCurrencyBalance(ALICE.getSecretPhrase(), currencyId, ChildChain.SEMAR);
        Assert.assertEquals(new AccountCurrencyBalance(-1000 * 95 - ChildChain.SEMAR.ONE_COIN, -ChildChain.SEMAR.ONE_COIN, -500, 0),
        ...
        apiCall = new APICall.Builder("transferCurrency").
                secretPhrase(ALICE.getSecretPhrase()).feeNQT(ChildChain.SEMAR.ONE_COIN).
                param("currency", currencyId).
        ...
        AccountCurrencyBalance afterTransferBuyerBalance = new AccountCurrencyBalance(ALICE.getSecretPhrase(), currencyId, ChildChain.SEMAR);
        Assert.assertEquals(new AccountCurrencyBalance(-ChildChain.SEMAR.ONE_COIN, -ChildChain.SEMAR.ONE_COIN, -2000, -2000),
                afterTransferBuyerBalance.diff(afterOfferBuyerBalance));

        AccountCurrencyBalance afterTransferSellerBalance = new AccountCurrencyBalance(BOB.getSecretPhrase(), currencyId, ChildChain.SEMAR);
        ...
        AccountCurrencyBalance afterBuyBuyerBalance = new AccountCurrencyBalance(ALICE.getSecretPhrase(), currencyId, ChildChain.SEMAR);
        Assert.assertEquals(new AccountCurrencyBalance(0, -19000, 0, 200),
                afterBuyBuyerBalance.diff(afterTransferBuyerBalance));

        AccountCurrencyBalance afterBuySellerBalance = new AccountCurrencyBalance(BOB.getSecretPhrase(), currencyId, ChildChain.SEMAR);
        Assert.assertEquals(new AccountCurrencyBalance(19000- ChildChain.SEMAR.ONE_COIN, 19000- ChildChain.SEMAR.ONE_COIN, -200, -200),
