...
public class TestCurrencyReserveAndClaim extends BlockchainTest {
    ...
    public void cancelCrowdFunding() {
        ...
        long balanceNQT1 = ALICE.getChainBalance(ChildChain.SEMAR.getId());
        long balanceNQT2 = BOB.getChainBalance(ChildChain.SEMAR.getId());
        reserveIncreaseImpl(currencyId, ALICE.getSecretPhrase(), BOB.getSecretPhrase());
        ...
        APICall apiCall = new APICall.Builder("getCurrencyFounders").
                feeNQT(ChildChain.SEMAR.ONE_COIN).
        ...
        Assert.assertEquals(balanceNQT1 - ChildChain.SEMAR.ONE_COIN, ALICE.getChainBalance(ChildChain.SEMAR.getId()));
        Assert.assertEquals(balanceNQT2 - 2* ChildChain.SEMAR.ONE_COIN, BOB.getChainBalance(ChildChain.SEMAR.getId()));
    }
    ...
    public void crowdFundingDistribution() {
        ...
        Assert.assertEquals(balanceNQT1 - ChildChain.SEMAR.ONE_COIN - 200000 + (100000*10), ALICE.getChainBalance(ChildChain.SEMAR.getId()));
        Assert.assertEquals(balanceNQT2 - 2*ChildChain.SEMAR.ONE_COIN - 800000, BOB.getChainBalance(ChildChain.SEMAR.getId()));
    }
    ...
    public void crowdFundingDistributionRounding() {
        ...
        long balanceNQT1 = ALICE.getChainBalance(ChildChain.SEMAR.getId());
        long balanceNQT2 = BOB.getChainBalance(ChildChain.SEMAR.getId());
        long balanceNQT3 = CHUCK.getChainBalance(ChildChain.SEMAR.getId());
        ...
        Assert.assertEquals(balanceNQT1 + 24 * 10, ALICE.getChainBalance(ChildChain.SEMAR.getId()));
        Assert.assertEquals(balanceNQT2 - ChildChain.SEMAR.ONE_COIN - 24 * 2, BOB.getChainBalance(ChildChain.SEMAR.getId()));
        Assert.assertEquals(balanceNQT3 - 2 * ChildChain.SEMAR.ONE_COIN - 24 * 8, CHUCK.getChainBalance(ChildChain.SEMAR.getId()));
