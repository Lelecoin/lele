...
public class TestCurrencyIssuance extends BlockchainTest {
    ...
    public void issueMultipleCurrencies() {
        ...
        apiCall = new Builder().naming("bXbx", "BXBX", "Currency B").feeNQT(1000 * ChildChain.SEMAR.ONE_COIN).build();
        issueCurrencyApi(apiCall);
        apiCall = new Builder().naming("ccXcc", "CCCXC", "Currency C").feeNQT(40 * ChildChain.SEMAR.ONE_COIN).build();
        issueCurrencyApi(apiCall);
    ...
    public static class Builder extends APICall.Builder {
        ...
        public Builder() {
            ...
            feeNQT(40 * ChildChain.SEMAR.ONE_COIN);
        }
        ...
        public Builder naming(String name, String code, String description) {
            ...
            feeNQT(FEE_STEPS[code.length()] * ChildChain.SEMAR.ONE_COIN);
            return this;
        }
