...
public class TestAutomatedShuffling extends BlockchainTest {
    ...
    private static final int chainId = ChildChain.SEMAR.getId();
    ...
    public void successfulShuffling() {
        ...
        Assert.assertEquals(-ChildChain.SEMAR.ONE_COIN, ALICE.getChainBalanceDiff(chainId));
        Assert.assertEquals(-(defaultShufflingAmount + 11 * ChildChain.SEMAR.ONE_COIN), ALICE.getChainUnconfirmedBalanceDiff(chainId));
        Assert.assertEquals(-ChildChain.SEMAR.ONE_COIN, BOB.getChainBalanceDiff(chainId));
        Assert.assertEquals(-(defaultShufflingAmount + ChildChain.SEMAR.ONE_COIN), BOB.getChainUnconfirmedBalanceDiff(chainId));
        Assert.assertEquals(-ChildChain.SEMAR.ONE_COIN, CHUCK.getChainBalanceDiff(chainId));
        Assert.assertEquals(-(defaultShufflingAmount + ChildChain.SEMAR.ONE_COIN), CHUCK.getChainUnconfirmedBalanceDiff(chainId));
        Assert.assertEquals(-ChildChain.SEMAR.ONE_COIN, DAVE.getChainBalanceDiff(chainId));
        Assert.assertEquals(-(defaultShufflingAmount + ChildChain.SEMAR.ONE_COIN), DAVE.getChainUnconfirmedBalanceDiff(chainId));
        ...
        Assert.assertEquals(-(defaultShufflingAmount + 12 * ChildChain.SEMAR.ONE_COIN), ALICE.getChainBalanceDiff(chainId));
        Assert.assertEquals(-(defaultShufflingAmount + 12 * ChildChain.SEMAR.ONE_COIN), ALICE.getChainUnconfirmedBalanceDiff(chainId));
        Assert.assertEquals(-(defaultShufflingAmount + 12 * ChildChain.SEMAR.ONE_COIN), BOB.getChainBalanceDiff(chainId));
        Assert.assertEquals(-(defaultShufflingAmount + 12 * ChildChain.SEMAR.ONE_COIN), BOB.getChainUnconfirmedBalanceDiff(chainId));
        Assert.assertEquals(-(defaultShufflingAmount + 12 * ChildChain.SEMAR.ONE_COIN), CHUCK.getChainBalanceDiff(chainId));
        Assert.assertEquals(-(defaultShufflingAmount + 12 * ChildChain.SEMAR.ONE_COIN), CHUCK.getChainUnconfirmedBalanceDiff(chainId));
        Assert.assertEquals(-(defaultShufflingAmount + 12 * ChildChain.SEMAR.ONE_COIN), DAVE.getChainBalanceDiff(chainId));
        Assert.assertEquals(-(defaultShufflingAmount + 12 * ChildChain.SEMAR.ONE_COIN), DAVE.getChainUnconfirmedBalanceDiff(chainId));
        ...
        Assert.assertEquals(48 * ChildChain.SEMAR.ONE_COIN, FORGY.getChainBalanceDiff(chainId));
        Assert.assertEquals(48 * ChildChain.SEMAR.ONE_COIN, FORGY.getChainUnconfirmedBalanceDiff(chainId));
    ...
    public void successfulAssetShuffling() {
        ...
        Assert.assertEquals(-(ChildChain.SEMAR.SHUFFLING_DEPOSIT_NQT + 12 * ChildChain.SEMAR.ONE_COIN + 1003 * ChildChain.SEMAR.ONE_COIN), ALICE.getChainBalanceDiff(chainId));
        Assert.assertEquals(-(ChildChain.SEMAR.SHUFFLING_DEPOSIT_NQT + 12 * ChildChain.SEMAR.ONE_COIN + 1003 * ChildChain.SEMAR.ONE_COIN), ALICE.getChainUnconfirmedBalanceDiff(chainId));
        Assert.assertEquals(-(ChildChain.SEMAR.SHUFFLING_DEPOSIT_NQT + 12 * ChildChain.SEMAR.ONE_COIN), BOB.getChainBalanceDiff(chainId));
        Assert.assertEquals(-(ChildChain.SEMAR.SHUFFLING_DEPOSIT_NQT + 12 * ChildChain.SEMAR.ONE_COIN), BOB.getChainUnconfirmedBalanceDiff(chainId));
        Assert.assertEquals(-(ChildChain.SEMAR.SHUFFLING_DEPOSIT_NQT + 12 * ChildChain.SEMAR.ONE_COIN), CHUCK.getChainBalanceDiff(chainId));
        Assert.assertEquals(-(ChildChain.SEMAR.SHUFFLING_DEPOSIT_NQT + 12 * ChildChain.SEMAR.ONE_COIN), CHUCK.getChainUnconfirmedBalanceDiff(chainId));
        Assert.assertEquals(-(ChildChain.SEMAR.SHUFFLING_DEPOSIT_NQT + 12 * ChildChain.SEMAR.ONE_COIN), DAVE.getChainBalanceDiff(chainId));
        Assert.assertEquals(-(ChildChain.SEMAR.SHUFFLING_DEPOSIT_NQT + 12 * ChildChain.SEMAR.ONE_COIN), DAVE.getChainUnconfirmedBalanceDiff(chainId));

        Assert.assertEquals(ChildChain.SEMAR.SHUFFLING_DEPOSIT_NQT, ALICE_RECIPIENT.getChainBalanceDiff(chainId));
        Assert.assertEquals(ChildChain.SEMAR.SHUFFLING_DEPOSIT_NQT, ALICE_RECIPIENT.getChainUnconfirmedBalanceDiff(chainId));
        Assert.assertEquals(ChildChain.SEMAR.SHUFFLING_DEPOSIT_NQT, BOB_RECIPIENT.getChainBalanceDiff(chainId));
        Assert.assertEquals(ChildChain.SEMAR.SHUFFLING_DEPOSIT_NQT, BOB_RECIPIENT.getChainUnconfirmedBalanceDiff(chainId));
        Assert.assertEquals(ChildChain.SEMAR.SHUFFLING_DEPOSIT_NQT, CHUCK_RECIPIENT.getChainBalanceDiff(chainId));
        Assert.assertEquals(ChildChain.SEMAR.SHUFFLING_DEPOSIT_NQT, CHUCK_RECIPIENT.getChainUnconfirmedBalanceDiff(chainId));
        Assert.assertEquals(ChildChain.SEMAR.SHUFFLING_DEPOSIT_NQT, DAVE_RECIPIENT.getChainBalanceDiff(chainId));
        Assert.assertEquals(ChildChain.SEMAR.SHUFFLING_DEPOSIT_NQT, DAVE_RECIPIENT.getChainUnconfirmedBalanceDiff(chainId));

        Assert.assertEquals(48 * ChildChain.SEMAR.ONE_COIN + 1003 * ChildChain.SEMAR.ONE_COIN, FORGY.getChainBalanceDiff(chainId));
        Assert.assertEquals(48 * ChildChain.SEMAR.ONE_COIN + 1003 * ChildChain.SEMAR.ONE_COIN, FORGY.getChainUnconfirmedBalanceDiff(chainId));
    ...
    public void successfulCurrencyShuffling() {
        ...
        Assert.assertEquals(-(ChildChain.SEMAR.SHUFFLING_DEPOSIT_NQT + 12 * ChildChain.SEMAR.ONE_COIN + 3 * ChildChain.SEMAR.ONE_COIN + 1000 * ChildChain.SEMAR.ONE_COIN), ALICE.getChainBalanceDiff(chainId));
        Assert.assertEquals(-(ChildChain.SEMAR.SHUFFLING_DEPOSIT_NQT + 12 * ChildChain.SEMAR.ONE_COIN + 3 * ChildChain.SEMAR.ONE_COIN + 1000 * ChildChain.SEMAR.ONE_COIN), ALICE.getChainUnconfirmedBalanceDiff(chainId));
        Assert.assertEquals(-(ChildChain.SEMAR.SHUFFLING_DEPOSIT_NQT + 12 * ChildChain.SEMAR.ONE_COIN), BOB.getChainBalanceDiff(chainId));
        Assert.assertEquals(-(ChildChain.SEMAR.SHUFFLING_DEPOSIT_NQT + 12 * ChildChain.SEMAR.ONE_COIN), BOB.getChainUnconfirmedBalanceDiff(chainId));
        Assert.assertEquals(-(ChildChain.SEMAR.SHUFFLING_DEPOSIT_NQT + 12 * ChildChain.SEMAR.ONE_COIN), CHUCK.getChainBalanceDiff(chainId));
        Assert.assertEquals(-(ChildChain.SEMAR.SHUFFLING_DEPOSIT_NQT + 12 * ChildChain.SEMAR.ONE_COIN), CHUCK.getChainUnconfirmedBalanceDiff(chainId));
        ...
        Assert.assertEquals(48 * ChildChain.SEMAR.ONE_COIN + 3 * ChildChain.SEMAR.ONE_COIN + 1000 * ChildChain.SEMAR.ONE_COIN, FORGY.getChainBalanceDiff(chainId));
        Assert.assertEquals(48 * ChildChain.SEMAR.ONE_COIN + 3 * ChildChain.SEMAR.ONE_COIN + 1000 * ChildChain.SEMAR.ONE_COIN, FORGY.getChainUnconfirmedBalanceDiff(chainId));
    ...
    public void registrationNotFinished() {
        ...
        Assert.assertEquals(-ChildChain.SEMAR.ONE_COIN, ALICE.getChainBalanceDiff(chainId));
        Assert.assertEquals(-ChildChain.SEMAR.ONE_COIN, ALICE.getChainUnconfirmedBalanceDiff(chainId));
        Assert.assertEquals(-ChildChain.SEMAR.ONE_COIN, BOB.getChainBalanceDiff(chainId));
        Assert.assertEquals(-ChildChain.SEMAR.ONE_COIN, BOB.getChainUnconfirmedBalanceDiff(chainId));

        Assert.assertNull(ALICE_RECIPIENT.getAccount());
        Assert.assertNull(BOB_RECIPIENT.getAccount());

        Assert.assertEquals(2 * ChildChain.SEMAR.ONE_COIN, FORGY.getChainBalanceDiff(chainId));
        Assert.assertEquals(2 * ChildChain.SEMAR.ONE_COIN, FORGY.getChainUnconfirmedBalanceDiff(chainId));
    ...
    public void registrationNotFinishedAsset() {
        ...
        Assert.assertEquals(-ChildChain.SEMAR.ONE_COIN - 1003 * ChildChain.SEMAR.ONE_COIN, ALICE.getChainBalanceDiff(chainId));
        Assert.assertEquals(-ChildChain.SEMAR.ONE_COIN - 1003 * ChildChain.SEMAR.ONE_COIN, ALICE.getChainUnconfirmedBalanceDiff(chainId));
        Assert.assertEquals(-ChildChain.SEMAR.ONE_COIN, BOB.getChainBalanceDiff(chainId));
        Assert.assertEquals(-ChildChain.SEMAR.ONE_COIN, BOB.getChainUnconfirmedBalanceDiff(chainId));
        ...
        Assert.assertEquals(2 * ChildChain.SEMAR.ONE_COIN + 1003 * ChildChain.SEMAR.ONE_COIN, FORGY.getChainBalanceDiff(chainId));
        Assert.assertEquals(2 * ChildChain.SEMAR.ONE_COIN + 1003 * ChildChain.SEMAR.ONE_COIN, FORGY.getChainUnconfirmedBalanceDiff(chainId));
    ...
    public void processingNotStarted() {
        ...
        Assert.assertEquals(-(ChildChain.SEMAR.SHUFFLING_DEPOSIT_NQT + ChildChain.SEMAR.ONE_COIN), ALICE.getChainBalanceDiff(chainId));
        Assert.assertEquals(-(ChildChain.SEMAR.SHUFFLING_DEPOSIT_NQT + ChildChain.SEMAR.ONE_COIN), ALICE.getChainUnconfirmedBalanceDiff(chainId));
        Assert.assertEquals(-ChildChain.SEMAR.ONE_COIN, BOB.getChainBalanceDiff(chainId));
        Assert.assertEquals(-ChildChain.SEMAR.ONE_COIN, BOB.getChainUnconfirmedBalanceDiff(chainId));
        Assert.assertEquals(-ChildChain.SEMAR.ONE_COIN, CHUCK.getChainBalanceDiff(chainId));
        Assert.assertEquals(-ChildChain.SEMAR.ONE_COIN, CHUCK.getChainUnconfirmedBalanceDiff(chainId));
        Assert.assertEquals(-ChildChain.SEMAR.ONE_COIN, DAVE.getChainBalanceDiff(chainId));
        Assert.assertEquals(-ChildChain.SEMAR.ONE_COIN, DAVE.getChainUnconfirmedBalanceDiff(chainId));
        ...
        Assert.assertEquals(4 * ChildChain.SEMAR.ONE_COIN + ChildChain.SEMAR.SHUFFLING_DEPOSIT_NQT, FORGY.getChainBalanceDiff(chainId));
        Assert.assertEquals(4 * ChildChain.SEMAR.ONE_COIN + ChildChain.SEMAR.SHUFFLING_DEPOSIT_NQT, FORGY.getChainUnconfirmedBalanceDiff(chainId));
    ...
    public void processingNotStartedCurrency() {
        ...
        Assert.assertEquals(-(ChildChain.SEMAR.SHUFFLING_DEPOSIT_NQT + ChildChain.SEMAR.ONE_COIN + 3 * ChildChain.SEMAR.ONE_COIN + 1000 * ChildChain.SEMAR.ONE_COIN), ALICE.getChainBalanceDiff(chainId));
        Assert.assertEquals(-(ChildChain.SEMAR.SHUFFLING_DEPOSIT_NQT + ChildChain.SEMAR.ONE_COIN + 3 * ChildChain.SEMAR.ONE_COIN + 1000 * ChildChain.SEMAR.ONE_COIN), ALICE.getChainUnconfirmedBalanceDiff(chainId));
        Assert.assertEquals(-ChildChain.SEMAR.ONE_COIN, BOB.getChainBalanceDiff(chainId));
        Assert.assertEquals(-ChildChain.SEMAR.ONE_COIN, BOB.getChainUnconfirmedBalanceDiff(chainId));
        Assert.assertEquals(-ChildChain.SEMAR.ONE_COIN, CHUCK.getChainBalanceDiff(chainId));
        Assert.assertEquals(-ChildChain.SEMAR.ONE_COIN, CHUCK.getChainUnconfirmedBalanceDiff(chainId));
        ...
        Assert.assertEquals(4 * ChildChain.SEMAR.ONE_COIN + ChildChain.SEMAR.SHUFFLING_DEPOSIT_NQT + 3 *  ChildChain.SEMAR.ONE_COIN + 1000 * ChildChain.SEMAR.ONE_COIN, FORGY.getChainBalanceDiff(chainId));
        Assert.assertEquals(4 * ChildChain.SEMAR.ONE_COIN + ChildChain.SEMAR.SHUFFLING_DEPOSIT_NQT + 3 *  ChildChain.SEMAR.ONE_COIN + 1000 * ChildChain.SEMAR.ONE_COIN, FORGY.getChainUnconfirmedBalanceDiff(chainId));
    ...
    public void tooManyParticipants() {
        ...
        Assert.assertEquals(3 * ChildChain.SEMAR.ONE_COIN + ChildChain.SEMAR.SHUFFLING_DEPOSIT_NQT, FORGY.getChainBalanceDiff(chainId));
        Assert.assertEquals(3 * ChildChain.SEMAR.ONE_COIN + ChildChain.SEMAR.SHUFFLING_DEPOSIT_NQT, FORGY.getChainUnconfirmedBalanceDiff(chainId));
    ...
    public void processingNotFinished() {
        ...
        Assert.assertEquals(-11 * ChildChain.SEMAR.ONE_COIN, ALICE.getChainBalanceDiff(chainId));
        Assert.assertEquals(-11 * ChildChain.SEMAR.ONE_COIN, ALICE.getChainUnconfirmedBalanceDiff(chainId));
        Assert.assertEquals(-11 * ChildChain.SEMAR.ONE_COIN, BOB.getChainBalanceDiff(chainId));
        Assert.assertEquals(-11 * ChildChain.SEMAR.ONE_COIN, BOB.getChainUnconfirmedBalanceDiff(chainId));
        Assert.assertEquals(-11 * ChildChain.SEMAR.ONE_COIN, CHUCK.getChainBalanceDiff(chainId));
        Assert.assertEquals(-11 * ChildChain.SEMAR.ONE_COIN, CHUCK.getChainUnconfirmedBalanceDiff(chainId));
        Assert.assertEquals(-(ChildChain.SEMAR.SHUFFLING_DEPOSIT_NQT + ChildChain.SEMAR.ONE_COIN), DAVE.getChainBalanceDiff(chainId));
        Assert.assertEquals(-(ChildChain.SEMAR.SHUFFLING_DEPOSIT_NQT + ChildChain.SEMAR.ONE_COIN), DAVE.getChainUnconfirmedBalanceDiff(chainId));
        ...
        Assert.assertEquals(34 * ChildChain.SEMAR.ONE_COIN + ChildChain.SEMAR.SHUFFLING_DEPOSIT_NQT, FORGY.getChainBalanceDiff(chainId));
        Assert.assertEquals(34 * ChildChain.SEMAR.ONE_COIN + ChildChain.SEMAR.SHUFFLING_DEPOSIT_NQT, FORGY.getChainUnconfirmedBalanceDiff(chainId));
    ...
    public void verifyNotFinished() {
        ...
        Assert.assertEquals(-12 * ChildChain.SEMAR.ONE_COIN, ALICE.getChainBalanceDiff(chainId));
        Assert.assertEquals(-12 * ChildChain.SEMAR.ONE_COIN, ALICE.getChainUnconfirmedBalanceDiff(chainId));
        Assert.assertEquals(-12 * ChildChain.SEMAR.ONE_COIN, BOB.getChainBalanceDiff(chainId));
        Assert.assertEquals(-12 * ChildChain.SEMAR.ONE_COIN, BOB.getChainUnconfirmedBalanceDiff(chainId));
        Assert.assertEquals(-(ChildChain.SEMAR.SHUFFLING_DEPOSIT_NQT + 11 * ChildChain.SEMAR.ONE_COIN), CHUCK.getChainBalanceDiff(chainId));
        Assert.assertEquals(-(ChildChain.SEMAR.SHUFFLING_DEPOSIT_NQT + 11 * ChildChain.SEMAR.ONE_COIN), CHUCK.getChainUnconfirmedBalanceDiff(chainId));
        Assert.assertEquals(-12 * ChildChain.SEMAR.ONE_COIN, DAVE.getChainBalanceDiff(chainId));
        Assert.assertEquals(-12 * ChildChain.SEMAR.ONE_COIN, DAVE.getChainUnconfirmedBalanceDiff(chainId));
        ...
        Assert.assertEquals(47 * ChildChain.SEMAR.ONE_COIN + ChildChain.SEMAR.SHUFFLING_DEPOSIT_NQT, FORGY.getChainBalanceDiff(chainId));
        Assert.assertEquals(47 * ChildChain.SEMAR.ONE_COIN + ChildChain.SEMAR.SHUFFLING_DEPOSIT_NQT, FORGY.getChainUnconfirmedBalanceDiff(chainId));
    ...
    public void cancelAfterVerifyChuck() {
        ...
        Assert.assertEquals(-22 * ChildChain.SEMAR.ONE_COIN, ALICE.getChainBalanceDiff(chainId));
        Assert.assertEquals(-22 * ChildChain.SEMAR.ONE_COIN, ALICE.getChainUnconfirmedBalanceDiff(chainId));
        Assert.assertEquals(-22 * ChildChain.SEMAR.ONE_COIN, BOB.getChainBalanceDiff(chainId));
        Assert.assertEquals(-22 * ChildChain.SEMAR.ONE_COIN, BOB.getChainUnconfirmedBalanceDiff(chainId));
        Assert.assertEquals(-(ChildChain.SEMAR.SHUFFLING_DEPOSIT_NQT + 21 * ChildChain.SEMAR.ONE_COIN), CHUCK.getChainBalanceDiff(chainId));
        Assert.assertEquals(-(ChildChain.SEMAR.SHUFFLING_DEPOSIT_NQT + 21 * ChildChain.SEMAR.ONE_COIN), CHUCK.getChainUnconfirmedBalanceDiff(chainId));
        Assert.assertEquals(-12 * ChildChain.SEMAR.ONE_COIN, DAVE.getChainBalanceDiff(chainId));
        Assert.assertEquals(-12 * ChildChain.SEMAR.ONE_COIN, DAVE.getChainUnconfirmedBalanceDiff(chainId));
        ...
        Assert.assertEquals(77 * ChildChain.SEMAR.ONE_COIN + ChildChain.SEMAR.SHUFFLING_DEPOSIT_NQT, FORGY.getChainBalanceDiff(chainId));
        Assert.assertEquals(77 * ChildChain.SEMAR.ONE_COIN + ChildChain.SEMAR.SHUFFLING_DEPOSIT_NQT, FORGY.getChainUnconfirmedBalanceDiff(chainId));
    ...
    public void cancelAfterVerifyChuckInvalidKeysAlice() {
        ...
        Assert.assertEquals(-(ChildChain.SEMAR.SHUFFLING_DEPOSIT_NQT + 22 * ChildChain.SEMAR.ONE_COIN), ALICE.getChainBalanceDiff(chainId));
        Assert.assertEquals(-(ChildChain.SEMAR.SHUFFLING_DEPOSIT_NQT + 22 * ChildChain.SEMAR.ONE_COIN), ALICE.getChainUnconfirmedBalanceDiff(chainId));
        Assert.assertEquals(-22 * ChildChain.SEMAR.ONE_COIN, BOB.getChainBalanceDiff(chainId));
        Assert.assertEquals(-22 * ChildChain.SEMAR.ONE_COIN, BOB.getChainUnconfirmedBalanceDiff(chainId));
        Assert.assertEquals(-21 * ChildChain.SEMAR.ONE_COIN, CHUCK.getChainBalanceDiff(chainId));
        Assert.assertEquals(-21 * ChildChain.SEMAR.ONE_COIN, CHUCK.getChainUnconfirmedBalanceDiff(chainId));
        Assert.assertEquals(-12 * ChildChain.SEMAR.ONE_COIN, DAVE.getChainBalanceDiff(chainId));
        Assert.assertEquals(-12 * ChildChain.SEMAR.ONE_COIN, DAVE.getChainUnconfirmedBalanceDiff(chainId));
    ...
    public void badProcessDataAlice() {
        ...
        Assert.assertEquals(-(ChildChain.SEMAR.SHUFFLING_DEPOSIT_NQT + 11 * ChildChain.SEMAR.ONE_COIN), ALICE.getChainBalanceDiff(chainId));
        Assert.assertEquals(-(ChildChain.SEMAR.SHUFFLING_DEPOSIT_NQT + 11 * ChildChain.SEMAR.ONE_COIN), ALICE.getChainUnconfirmedBalanceDiff(chainId));
        Assert.assertEquals(-11 * ChildChain.SEMAR.ONE_COIN, BOB.getChainBalanceDiff(chainId));
        Assert.assertEquals(-11 * ChildChain.SEMAR.ONE_COIN, BOB.getChainUnconfirmedBalanceDiff(chainId));
        Assert.assertEquals(-1 * ChildChain.SEMAR.ONE_COIN, CHUCK.getChainBalanceDiff(chainId));
        Assert.assertEquals(-1 * ChildChain.SEMAR.ONE_COIN, CHUCK.getChainUnconfirmedBalanceDiff(chainId));
        Assert.assertEquals(-1 * ChildChain.SEMAR.ONE_COIN, DAVE.getChainBalanceDiff(chainId));
        Assert.assertEquals(-1 * ChildChain.SEMAR.ONE_COIN, DAVE.getChainUnconfirmedBalanceDiff(chainId));
        ...
        Assert.assertEquals(24 * ChildChain.SEMAR.ONE_COIN + ChildChain.SEMAR.SHUFFLING_DEPOSIT_NQT, FORGY.getChainBalanceDiff(chainId));
        Assert.assertEquals(24 * ChildChain.SEMAR.ONE_COIN + ChildChain.SEMAR.SHUFFLING_DEPOSIT_NQT, FORGY.getChainUnconfirmedBalanceDiff(chainId));
    ...
    public void modifiedProcessDataBob() {
        ...
        Assert.assertEquals(-21 * ChildChain.SEMAR.ONE_COIN, ALICE.getChainBalanceDiff(chainId));
        Assert.assertEquals(-21 * ChildChain.SEMAR.ONE_COIN, ALICE.getChainUnconfirmedBalanceDiff(chainId));
        Assert.assertEquals(-(ChildChain.SEMAR.SHUFFLING_DEPOSIT_NQT + (bobCancelFailed ? 11 : 21) * ChildChain.SEMAR.ONE_COIN), BOB.getChainBalanceDiff(chainId));
        Assert.assertEquals(-(ChildChain.SEMAR.SHUFFLING_DEPOSIT_NQT + (bobCancelFailed ? 11 : 21) * ChildChain.SEMAR.ONE_COIN), BOB.getChainUnconfirmedBalanceDiff(chainId));
        Assert.assertEquals(-11 * ChildChain.SEMAR.ONE_COIN, CHUCK.getChainBalanceDiff(chainId));
        Assert.assertEquals(-11 * ChildChain.SEMAR.ONE_COIN, CHUCK.getChainUnconfirmedBalanceDiff(chainId));
        Assert.assertEquals(-1 * ChildChain.SEMAR.ONE_COIN, DAVE.getChainBalanceDiff(chainId));
        Assert.assertEquals(-1 * ChildChain.SEMAR.ONE_COIN, DAVE.getChainUnconfirmedBalanceDiff(chainId));
        ...
        Assert.assertEquals((bobCancelFailed ? 44 : 54) * ChildChain.SEMAR.ONE_COIN + ChildChain.SEMAR.SHUFFLING_DEPOSIT_NQT, FORGY.getChainBalanceDiff(chainId));
        Assert.assertEquals((bobCancelFailed ? 44 : 54) * ChildChain.SEMAR.ONE_COIN + ChildChain.SEMAR.SHUFFLING_DEPOSIT_NQT, FORGY.getChainUnconfirmedBalanceDiff(chainId));
    ...
    public void duplicateProcessDataBob() {
        ...
        Assert.assertEquals(-21 * ChildChain.SEMAR.ONE_COIN, ALICE.getChainBalanceDiff(chainId));
        Assert.assertEquals(-21 * ChildChain.SEMAR.ONE_COIN, ALICE.getChainUnconfirmedBalanceDiff(chainId));
        Assert.assertEquals(-(ChildChain.SEMAR.SHUFFLING_DEPOSIT_NQT + 21 * ChildChain.SEMAR.ONE_COIN), BOB.getChainBalanceDiff(chainId));
        Assert.assertEquals(-(ChildChain.SEMAR.SHUFFLING_DEPOSIT_NQT + 21 * ChildChain.SEMAR.ONE_COIN), BOB.getChainUnconfirmedBalanceDiff(chainId));
        Assert.assertEquals(-11 * ChildChain.SEMAR.ONE_COIN, CHUCK.getChainBalanceDiff(chainId));
        Assert.assertEquals(-11 * ChildChain.SEMAR.ONE_COIN, CHUCK.getChainUnconfirmedBalanceDiff(chainId));
        Assert.assertEquals(-1 * ChildChain.SEMAR.ONE_COIN, DAVE.getChainBalanceDiff(chainId));
        Assert.assertEquals(-1 * ChildChain.SEMAR.ONE_COIN, DAVE.getChainUnconfirmedBalanceDiff(chainId));
        ...
        Assert.assertEquals(54 * ChildChain.SEMAR.ONE_COIN + ChildChain.SEMAR.SHUFFLING_DEPOSIT_NQT, FORGY.getChainBalanceDiff(chainId));
        Assert.assertEquals(54 * ChildChain.SEMAR.ONE_COIN + ChildChain.SEMAR.SHUFFLING_DEPOSIT_NQT, FORGY.getChainUnconfirmedBalanceDiff(chainId));
    ...
    public void modifiedProcessDataChuck() {
        ...
        Assert.assertEquals(-21 * ChildChain.SEMAR.ONE_COIN, ALICE.getChainBalanceDiff(chainId));
        Assert.assertEquals(-21 * ChildChain.SEMAR.ONE_COIN, ALICE.getChainUnconfirmedBalanceDiff(chainId));
        Assert.assertEquals(-21 * ChildChain.SEMAR.ONE_COIN, BOB.getChainBalanceDiff(chainId));
        Assert.assertEquals(-21 * ChildChain.SEMAR.ONE_COIN, BOB.getChainUnconfirmedBalanceDiff(chainId));
        Assert.assertEquals(-(ChildChain.SEMAR.SHUFFLING_DEPOSIT_NQT + (chuckCancelFailed ? 11 : 21) * ChildChain.SEMAR.ONE_COIN), CHUCK.getChainBalanceDiff(chainId));
        Assert.assertEquals(-(ChildChain.SEMAR.SHUFFLING_DEPOSIT_NQT + (chuckCancelFailed ? 11 : 21) * ChildChain.SEMAR.ONE_COIN), CHUCK.getChainUnconfirmedBalanceDiff(chainId));
        Assert.assertEquals(-12 * ChildChain.SEMAR.ONE_COIN, DAVE.getChainBalanceDiff(chainId));
        Assert.assertEquals(-12 * ChildChain.SEMAR.ONE_COIN, DAVE.getChainUnconfirmedBalanceDiff(chainId));
        ...
        Assert.assertEquals((chuckCancelFailed ? 65 : 75) * ChildChain.SEMAR.ONE_COIN + ChildChain.SEMAR.SHUFFLING_DEPOSIT_NQT, FORGY.getChainBalanceDiff(chainId));
        Assert.assertEquals((chuckCancelFailed ? 65 : 75) * ChildChain.SEMAR.ONE_COIN + ChildChain.SEMAR.SHUFFLING_DEPOSIT_NQT, FORGY.getChainUnconfirmedBalanceDiff(chainId));
    ...
    public void modifiedRecipientKeysDave() {
        ...
        Assert.assertEquals(-65 * ChildChain.SEMAR.ONE_COIN, ALICE.getChainBalanceDiff(chainId) + BOB.getChainBalanceDiff(chainId) + CHUCK.getChainBalanceDiff(chainId));
    ...
    public void duplicateProcessDataChuck() {
        ...
        Assert.assertEquals(-11 * ChildChain.SEMAR.ONE_COIN, BOB.getChainBalanceDiff(chainId));
        Assert.assertEquals(-11 * ChildChain.SEMAR.ONE_COIN, BOB.getChainUnconfirmedBalanceDiff(chainId));
        Assert.assertEquals(-(ChildChain.SEMAR.SHUFFLING_DEPOSIT_NQT + ChildChain.SEMAR.ONE_COIN), CHUCK.getChainBalanceDiff(chainId));
        Assert.assertEquals(-(ChildChain.SEMAR.SHUFFLING_DEPOSIT_NQT + ChildChain.SEMAR.ONE_COIN), CHUCK.getChainUnconfirmedBalanceDiff(chainId));
        Assert.assertEquals(-1 * ChildChain.SEMAR.ONE_COIN, DAVE.getChainBalanceDiff(chainId));
        Assert.assertEquals(-1 * ChildChain.SEMAR.ONE_COIN, DAVE.getChainUnconfirmedBalanceDiff(chainId));
    ...
    public void maxShufflingSize() {
        ...
        Assert.assertEquals(-(ChildChain.SEMAR.SHUFFLING_DEPOSIT_NQT + 12 * ChildChain.SEMAR.ONE_COIN) + 100 * ChildChain.SEMAR.ONE_COIN, participants[n - 1].getChainBalanceDiff(chainId));
        Assert.assertEquals(-(ChildChain.SEMAR.SHUFFLING_DEPOSIT_NQT + 12 * ChildChain.SEMAR.ONE_COIN) + 100 * ChildChain.SEMAR.ONE_COIN, participants[n - 1].getChainUnconfirmedBalanceDiff(chainId));
